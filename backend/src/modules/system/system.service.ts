...
const providerCatalog: ProviderCatalogEntry[] = [
  {
    ...
    models: ["SPF 5000", "MIN 5000TL", "MOD 10KTL3-X"],
    note: "Prioridade atual: use o login/senha do portal Growatt ou o token oficial para iniciar a telemetria.",
  },
  {
    code: "solarman",
    name: "Solarman / Deye",
    ...
    models: ["Deye Hybrid", "Deye String", "Logger Solarman"],
    note: "Muito usado por inversores Deye e gateways Solarman.",
  },
  {
    code: "goodwe",
    name: "GoodWe",
    ...
    models: ["GW5048D-ES", "GW10K-ET", "Lynx Home F"],
  },
  {
    code: "huawei",
    ...
    authModes: ["credentials", "token"],
    models: ["SUN2000-5KTL", "SUN2000-10KTL", "LUNA2000"],
  },
  {
    code: "generic",
    name: "API Genérica",
    authModes: ["token", "manual_assisted", "serial"],
    models: ["Gateway Modbus", "API REST", "Datalogger"],
    note: "Para APIs próprias do fabricante ou integrações manuais.",
  },
];
